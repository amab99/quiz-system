...
class TestLoginView(unittest.TestCase):
    ...
    def tearDown(self):
        """ Method to destroy the login view root after each test. """
        self.loginView.root.destroy()
    ...
    def test_create_widgets(self):
        ...
        - AssertionError: If error when creating the widget
         """
        self.assertIsInstance(self.loginView.root.logo_label.image, PhotoImage)
        self.assertIsInstance(self.loginView.root.logo_label, Label)
        self.assertIsInstance(self.loginView.root.title_label, Label)
        self.assertIsInstance(self.loginView.root.username_label, Label)
        self.assertIsInstance(self.loginView.root.username_entry, Entry)
        self.assertIsInstance(self.loginView.root.password_label, Label)
        self.assertIsInstance(self.loginView.root.password_entry, Entry)
        self.assertIsInstance(self.loginView.root.login_button, Button)
    ...
    def test_widgets_properties(self):
        ...
        """
        self.assertEqual(self.loginView.root.title_label['text'], "Login")
        self.assertEqual(self.loginView.root.title_label['font'], "{Source Serif Pro} 18")
        self.assertEqual(self.loginView.root.username_label['text'], "Username:")
        self.assertEqual(self.loginView.root.username_label['font'], "{Source Serif Pro} 14 italic")
        self.assertEqual(self.loginView.root.password_label['text'], "Password:")
        self.assertEqual(self.loginView.root.password_label['font'], "{Source Serif Pro} 14 italic")
        self.assertEqual(self.loginView.root.login_button['text'], "Login")
        self.assertEqual(self.loginView.root.login_button['background'], "#90CAF9")
    ...
    def test_Logo_Label_position(self):
        ...
        """
        logo_label_position = self.loginView.root.logo_label.grid_info()
    ...
    def test_title_Label_position(self):
        ...
        """
        title_label_position = self.loginView.root.title_label.grid_info()
    ...
    def test_username_Label_position(self):
        ...
        """
        username_label_position = self.loginView.root.username_label.grid_info()
    ...
    def test_username_entry_position(self):
        ...
        """
        username_entry_position = self.loginView.root.username_entry.grid_info()
    ...
    def test_password_Label_position(self):
        ...
        """
        password_label_position = self.loginView.root.password_label.grid_info()
    ...
    def test_password_entry_position(self):
        ...
        """
        password_entry_position = self.loginView.root.password_entry.grid_info()
    ...
    def test_login_button_position(self):
        ...
        """
        button_position = self.loginView.root.login_button.grid_info()
    ...
    def test_get_username(self):
        ...
        """
        self.loginView.root.username_entry.insert(0, "admin")
    ...
    def test_get_password(self):
        ...
        """
        self.loginView.root.password_entry.insert(0, "1234")
    ...
    def test_login_button_callback(self):
        ...
        self.loginView.root.login_button.invoke()
    ...
    def test_center_window(self, screen_width: int, screen_height: int):
        ...
        self.loginView.root.update_idletasks()

        # Expected center coordinates based on mocked screen width and height
        x = (800 - 400) // 2
        y = (600 - 450) // 2

        self.assertEqual(self.loginView.root.winfo_x(), x)
        self.assertEqual(self.loginView.root.winfo_y(), y)
