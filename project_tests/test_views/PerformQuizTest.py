...
class TestPerformQuizView(unittest.TestCase):
    ...
    def tearDown(self):
        """ Method to destroy the quiz view instance after each test. """
        self.quiz_view.destroy()
    ...
    def test_set_option2(self):
        ...
        self.quiz_view.opt2 = MagicMock()
        options = ["Paris", "Berlin", "Rome", "Madrid"]
        self.quiz_view.set_answer_options(options)
        self.quiz_view.opt2.config.assert_called_once_with(text=options[1])

    def test_set_option3(self):
        """ Test method to ensure the functionality of setting the third option correct to the radio button. """
        self.quiz_view.opt3 = MagicMock()
        options = ["Paris", "Berlin", "Rome", "Madrid"]
        self.quiz_view.set_answer_options(options)
        self.quiz_view.opt3.config.assert_called_once_with(text=options[2])
    ...
    def test_set_option4(self):
        ...
        self.quiz_view.opt4 = MagicMock()
        options = ["Paris", "Berlin", "Rome", "Madrid"]
        self.quiz_view.set_answer_options(options)
        self.quiz_view.opt4.config.assert_called_once_with(text=options[3])

    def test_set_selected_option(self):
        """ Test method to ensure the selection of an option. """
        # Mock the third option
        self.quiz_view.opt3 = MagicMock()
        self.quiz_view.option_var = MagicMock()
        # Mock the text string of the third option
        self.quiz_view.opt3.cget.return_value = "Test option"
        self.quiz_view.set_selected_option("Test option")
        self.quiz_view.option_var.set.assert_called_once_with(3)
    ...
    def test_clear_selected_options(self):
        ...
        self.quiz_view.option_var.set.assert_called_once_with(0)
    ...
    def test_prev_button_callback(self):
        ...
        self.quiz_view.prev_button.invoke()
    ...
    def test_next_button_callback(self):
        ...
        self.quiz_view.next_button.invoke()
        callback_mock.assert_called_once()
    ...
    def test_submit_button_callback(self):
        ...
        self.quiz_view.submit_button.invoke()
        callback_mock.assert_called_once()
    ...
    def test_set_prev_button_enabled(self):
        ...
        self.assertEqual(self.quiz_view.prev_button.cget("state"), "normal")
    ...
    def test_set_next_button_enabled(self):
        ...
        self.assertEqual(self.quiz_view.next_button.cget("state"), "normal")
    ...
    def test_get_selected_option1(self):
        ...
        self.quiz_view.option_var = MagicMock()
        self.quiz_view.opt1 = MagicMock()
        self.quiz_view.opt1.cget.return_value = "Stockholm"
        self.quiz_view.option_var.get.return_value = 1
    ...
    def test_get_selected_option2(self):
        ...
        self.quiz_view.option_var = MagicMock()
        self.quiz_view.opt2 = MagicMock()
        self.quiz_view.opt2.cget.return_value = "Berlin"
        self.quiz_view.option_var.get.return_value = 2
    ...
    def test_get_selected_option3(self):
        ...
        self.quiz_view.option_var = MagicMock()
        self.quiz_view.opt3 = MagicMock()
        self.quiz_view.opt3.cget.return_value = "Paris"
        self.quiz_view.option_var.get.return_value = 3
    ...
    def test_get_selected_option4(self):
        ...
        self.quiz_view.option_var = MagicMock()
        self.quiz_view.opt4 = MagicMock()
        self.quiz_view.opt4.cget.return_value = "Rome"
    ...
    def test_center_window(self, screen_width: int, screen_height: int):
        ...
        self.quiz_view.update_idletasks()
